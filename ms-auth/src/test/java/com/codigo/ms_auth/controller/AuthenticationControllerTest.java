...
public class AuthenticationControllerTest {
    ...
    public void testLogin() {
        ...
        SignInResponse expectedResponse = new SignInResponse("mocked-jwt-token", "correo@email.com", List.of("USUARIO"));
        ...
        assertEquals("correo@email.com", response.getBody().getEmail());
        assertEquals(List.of("USUARIO"), response.getBody().getRoles());
    }
