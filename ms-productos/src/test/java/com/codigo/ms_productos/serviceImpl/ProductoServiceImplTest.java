...
class ProductoServiceImplTest {
    ...
    void testObtenerProducto() {
        Producto producto = Producto.builder().id(1L).nombre("Monitor").precio(800.0).categoria("Tecnologia").build();
        when(productoRepository.findById(1L)).thenReturn(Optional.of(producto));

        Producto resultado = productoService.obtenerProducto(1L);
    ...
    void testExisteProducto() {
        ...
        assertTrue(productoService.existeProducto(1L));
